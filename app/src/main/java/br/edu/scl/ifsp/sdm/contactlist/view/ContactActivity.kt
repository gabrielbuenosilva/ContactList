    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recievedContact?.let { recieved ->
            ...
            with(acb) {
                ...
                nameEt.setText(recieved.name)
                addressEt.setText(recieved.address)
                phoneEt.setText(recieved.phone)
                emailEt.setText(recieved.email)
        ...
        with (acb) {
            ...
            saveBt.setOnClickListener {
                ...
                val contact = Contact(
                    ...
                    id = recievedContact?.id?:hashCode(),
